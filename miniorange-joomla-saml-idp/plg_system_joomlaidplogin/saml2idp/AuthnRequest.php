...
class AuthnRequest
{
	...
	/**
	 * Whether force authentication is required.
	 *
	 * @var  boolean
	 */
	private $forceAuthn;
	...
	/**
	 * Whether the request is passive.
	 *
	 * @var  boolean
	 */
	private $isPassive;
	...
	/**
	 * Requester identifiers from scoping.
	 *
	 * @var  array
	 */
